...
void MessagePublisher::initPublisher(
  rclcpp::Node & ref_ros_node_handle, SbgEComMsgId sbg_msg_id,
  ...
  const std::string & ref_output_topic)
{
  ...
  if (output_conf != SBG_ECOM_OUTPUT_MODE_DISABLED) {
    switch (sbg_msg_id) {
      case SBG_ECOM_LOG_STATUS:
        m_sbgStatus_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgStatus>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_UTC_TIME:
        m_sbgUtcTime_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgUtcTime>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_IMU_DATA:
        m_sbgImuData_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgImuData>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_MAG:
        m_sbgMag_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgMag>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_MAG_CALIB:
        m_sbgMagCalib_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgMagCalib>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_EKF_EULER:
        m_sbgEkfEuler_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgEkfEuler>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_EKF_QUAT:
        m_sbgEkfQuat_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgEkfQuat>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_EKF_NAV:

        m_sbgEkfNav_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgEkfNav>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_SHIP_MOTION:

        m_sbgShipMotion_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgShipMotion>(
          ref_output_topic, m_max_messages_);
        break;
      ...
      case SBG_ECOM_LOG_GPS2_VEL:
        ...
        m_sbgGpsVel_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgGpsVel>(
          ref_output_topic, m_max_messages_);
        break;
      ...
      case SBG_ECOM_LOG_GPS2_POS:
        ...
        m_sbgGpsPos_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgGpsPos>(
          ref_output_topic, m_max_messages_);
        break;
      ...
      case SBG_ECOM_LOG_GPS2_HDT:
        ...
        m_sbgGpsHdt_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgGpsHdt>(
          ref_output_topic, m_max_messages_);
        break;
      ...
      case SBG_ECOM_LOG_GPS2_RAW:
        ...
        m_sbgGpsRaw_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgGpsRaw>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_ODO_VEL:

        m_sbgOdoVel_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgOdoVel>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_EVENT_A:

        m_sbgEventA_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgEvent>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_EVENT_B:

        m_sbgEventB_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgEvent>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_EVENT_C:

        m_sbgEventC_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgEvent>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_EVENT_D:

        m_sbgEventD_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgEvent>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_EVENT_E:

        m_sbgEventE_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgEvent>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_IMU_SHORT:

        m_SbgImuShort_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgImuShort>(
          ref_output_topic, m_max_messages_);
        break;

      case SBG_ECOM_LOG_AIR_DATA:

        m_SbgAirData_pub_ = ref_ros_node_handle.create_publisher<sbg_driver::msg::SbgAirData>(
          ref_output_topic, m_max_messages_);
        break;
...
void MessagePublisher::defineRosStandardPublishers(
  rclcpp::Node & ref_ros_node_handle,
  bool odom_enable)
{
  if (m_sbgImuData_pub_ && (m_sbgEkfQuat_pub_ || m_sbgEkfEuler_pub_)) {
    m_imu_pub_ = ref_ros_node_handle.create_publisher<sensor_msgs::msg::Imu>(
      "imu/data",
      m_max_messages_);
  } else {
    RCLCPP_WARN(
      ref_ros_node_handle.get_logger(),
  ...
  if (m_sbgImuData_pub_) {
    m_temp_pub_ = ref_ros_node_handle.create_publisher<sensor_msgs::msg::Temperature>(
      "imu/temp",
      m_max_messages_);
  } else {
    RCLCPP_WARN(
  ...
  if (m_sbgMag_pub_) {
    m_mag_pub_ = ref_ros_node_handle.create_publisher<sensor_msgs::msg::MagneticField>(
      "imu/mag",
      m_max_messages_);
  } else {
    RCLCPP_WARN(
  ...
  if ((m_sbgEkfEuler_pub_ || m_sbgEkfQuat_pub_) && m_sbgEkfNav_pub_ && m_sbgImuData_pub_) {
    m_velocity_pub_ = ref_ros_node_handle.create_publisher<geometry_msgs::msg::TwistStamped>(
      "imu/velocity", m_max_messages_);
  } else {
    RCLCPP_WARN(
      ref_ros_node_handle.get_logger(),
  ...
  if (m_SbgAirData_pub_) {
    m_fluid_pub_ = ref_ros_node_handle.create_publisher<sensor_msgs::msg::FluidPressure>(
      "imu/pres",
      m_max_messages_);
  } else {
    RCLCPP_WARN(
  ...
  if (m_sbgEkfNav_pub_) {
    m_pos_ecef_pub_ = ref_ros_node_handle.create_publisher<geometry_msgs::msg::PointStamped>(
      "imu/pos_ecef", m_max_messages_);
  } else {
    RCLCPP_WARN(
      ref_ros_node_handle.get_logger(),
  ...
  if (m_sbgUtcTime_pub_) {
    m_utc_reference_pub_ = ref_ros_node_handle.create_publisher<sensor_msgs::msg::TimeReference>(
      "imu/utc_ref", m_max_messages_);
  } else {
    RCLCPP_WARN(
      ref_ros_node_handle.get_logger(),
  ...
  if (m_sbgGpsPos_pub_) {
    m_nav_sat_fix_pub_ = ref_ros_node_handle.create_publisher<sensor_msgs::msg::NavSatFix>(
      "imu/nav_sat_fix", m_max_messages_);
  } else {
    RCLCPP_WARN(
      ref_ros_node_handle.get_logger(),
  ...
  if (odom_enable) {
    if (m_sbgImuData_pub_ && m_sbgEkfNav_pub_ && (m_sbgEkfEuler_pub_ || m_sbgEkfQuat_pub_)) {
      m_odometry_pub_ = ref_ros_node_handle.create_publisher<nav_msgs::msg::Odometry>(
        "imu/odometry", m_max_messages_);
    } else {
      RCLCPP_WARN(
        ref_ros_node_handle.get_logger(),
...
void MessagePublisher::processRosVelMessage(void)
{
  if (m_velocity_pub_) {
    if (m_sbgEkfQuat_pub_) {
      m_velocity_pub_->publish(
        m_message_wrapper_.createRosTwistStampedMessage(
          m_sbg_ekf_quat_message_, m_sbg_ekf_nav_message_, m_sbg_imu_message_));
    } else if (m_sbgEkfEuler_pub_) {
      m_velocity_pub_->publish(
        m_message_wrapper_.createRosTwistStampedMessage(
          m_sbg_ekf_euler_message_, m_sbg_ekf_nav_message_, m_sbg_imu_message_));
    }
  }
}
  ...
  if (m_imu_pub_) {
    if (m_sbgEkfQuat_pub_) {
      if (m_sbg_imu_message_.time_stamp == m_sbg_ekf_quat_message_.time_stamp) {
        m_imu_pub_->publish(
          m_message_wrapper_.createRosImuMessage(
            m_sbg_imu_message_,
  ...
  if (m_odometry_pub_) {
    if (m_sbg_ekf_nav_message_.status.position_valid) {
      if (m_sbg_imu_message_.time_stamp == m_sbg_ekf_nav_message_.time_stamp) {
        ...
        if (m_sbgEkfQuat_pub_) {
          if (m_sbg_imu_message_.time_stamp == m_sbg_ekf_quat_message_.time_stamp) {
            m_odometry_pub_->publish(
              m_message_wrapper_.createRosOdoMessage(
                m_sbg_imu_message_,
                m_sbg_ekf_nav_message_, m_sbg_ekf_quat_message_, m_sbg_ekf_euler_message_));
          }
        } else {
          if (m_sbg_imu_message_.time_stamp == m_sbg_ekf_euler_message_.time_stamp) {
            m_odometry_pub_->publish(
              m_message_wrapper_.createRosOdoMessage(
                m_sbg_imu_message_,
                m_sbg_ekf_nav_message_, m_sbg_ekf_euler_message_));
          }
        }
      }
    }
...
void MessagePublisher::publishUtcData(const SbgBinaryLogData & ref_sbg_log)
{
  ...
  if (m_utc_reference_pub_) {
    if (sbg_utc_message.clock_status.clock_utc_status != SBG_ECOM_UTC_INVALID) {
      m_utc_reference_pub_->publish(
        m_message_wrapper_.createRosUtcTimeReferenceMessage(
          sbg_utc_message));
    }
  }
}
...
void MessagePublisher::initPublishers(
  rclcpp::Node & ref_ros_node_handle,
  const ConfigStore & ref_config_store)
{
  ...
  //
  const std::vector<ConfigStore::SbgLogOutput> & ref_output_modes =
    ref_config_store.getOutputModes();
  ...
  // added by Tim for nuway
  m_message_wrapper_.setUseManualDatum(ref_config_store.getUseManualDatum());
  m_message_wrapper_.setDatum(ref_config_store.getDatum());

  for (const ConfigStore::SbgLogOutput & ref_output : ref_output_modes) {
    initPublisher(
      ref_ros_node_handle, ref_output.message_id, ref_output.output_mode, getOutputTopicName(
        ref_output.message_id));
  }
...
void MessagePublisher::updateDatum(double Lat, double Long, double altitude){
  m_message_wrapper_.initUTM(Lat,Long, altitude);
}

void MessagePublisher::publish(
  SbgEComClass sbg_msg_class, SbgEComMsgId sbg_msg_id,
  ...
  if (sbg_msg_class == SBG_ECOM_CLASS_LOG_ECOM_0) {
    switch (sbg_msg_id) {
      case SBG_ECOM_LOG_STATUS:
        ...
        if (m_sbgStatus_pub_) {
          m_sbgStatus_pub_->publish(
            m_message_wrapper_.createSbgStatusMessage(
              ref_sbg_log.statusData));
        }
        break;
      ...
      case SBG_ECOM_LOG_MAG_CALIB:
        ...
        if (m_sbgMagCalib_pub_) {
          m_sbgMagCalib_pub_->publish(
            m_message_wrapper_.createSbgMagCalibMessage(
              ref_sbg_log.
              magCalibData));
        }
        break;
      ...
      case SBG_ECOM_LOG_EKF_EULER:
        ...
        if (m_sbgEkfEuler_pub_) {
          m_sbg_ekf_euler_message_ = m_message_wrapper_.createSbgEkfEulerMessage(
            ref_sbg_log.ekfEulerData);
      ...
      case SBG_ECOM_LOG_EKF_QUAT:
        ...
        if (m_sbgEkfQuat_pub_) {
          m_sbg_ekf_quat_message_ = m_message_wrapper_.createSbgEkfQuatMessage(
            ref_sbg_log.ekfQuatData);
      ...
      case SBG_ECOM_LOG_SHIP_MOTION:
        ...
        if (m_sbgShipMotion_pub_) {
          m_sbgShipMotion_pub_->publish(
            m_message_wrapper_.createSbgShipMotionMessage(
              ref_sbg_log.
              shipMotionData));
        }
        break;
      ...
      case SBG_ECOM_LOG_GPS2_VEL:
        ...
        if (m_sbgGpsVel_pub_) {
          m_sbgGpsVel_pub_->publish(
            m_message_wrapper_.createSbgGpsVelMessage(
              ref_sbg_log.gpsVelData));
        }
        break;
      ...
      case SBG_ECOM_LOG_GPS2_HDT:
        ...
        if (m_sbgGpsHdt_pub_) {
          m_sbgGpsHdt_pub_->publish(
            m_message_wrapper_.createSbgGpsHdtMessage(
              ref_sbg_log.gpsHdtData));
        }
        break;
      ...
      case SBG_ECOM_LOG_GPS2_RAW:
        ...
        if (m_sbgGpsRaw_pub_) {
          m_sbgGpsRaw_pub_->publish(
            m_message_wrapper_.createSbgGpsRawMessage(
              ref_sbg_log.gpsRawData));
        }
        break;
      ...
      case SBG_ECOM_LOG_ODO_VEL:
        ...
        if (m_sbgOdoVel_pub_) {
          m_sbgOdoVel_pub_->publish(
            m_message_wrapper_.createSbgOdoVelMessage(
              ref_sbg_log.
              odometerData));
        }
        break;
      ...
      case SBG_ECOM_LOG_EVENT_A:
        ...
        if (m_sbgEventA_pub_) {
          m_sbgEventA_pub_->publish(
            m_message_wrapper_.createSbgEventMessage(
              ref_sbg_log.eventMarker));
        }
        break;
      ...
      case SBG_ECOM_LOG_IMU_SHORT:
        ...
        if (m_SbgImuShort_pub_) {
          m_SbgImuShort_pub_->publish(
            m_message_wrapper_.createSbgImuShortMessage(
              ref_sbg_log.
              imuShort));
        }
        break;
